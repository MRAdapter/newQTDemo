...
static const char qt_meta_stringdata_fiveParamsWidget[] = {
    "fiveParamsWidget\0\0sendFiveParams(QString)\0"
    "sureBtn_click()\0backBtn_click()\0"
};
...
const QMetaObjectExtraData fiveParamsWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject fiveParamsWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_fiveParamsWidget,
      qt_meta_data_fiveParamsWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &fiveParamsWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_fiveParamsWidget))
